...
export class FooterComponent {
    ...
    /** `'esteso'` (default, storico): social visibili, orari come accordion. `'essenziale'`:
     *  social nascosti, orari come lista piatta. `DesignSystemPreset.footerIdentita`. */
    readonly identitaEstesa = ContestoSito.config.footerIdentita === 'esteso';
