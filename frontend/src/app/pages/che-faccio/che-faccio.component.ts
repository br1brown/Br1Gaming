 ...
 * dell'Engine — laboratorio markdown, builder immagini, QR, action components, contatti,
 * notifiche, tema/i18n/API/asset. Path diverso per lingua (non solo prefissato) — vedi `app.pages.ts`.
 */
@Component({
    selector: 'app-che-faccio',
    imports: [
        TranslatePipe,
        FormsModule,
