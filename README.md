...
- **Tema derivato, non incollato**: palette calcolata in OKLCH da un solo colore brand con contrasto WCAG garantito matematicamente, più override opzionali (secondario, sfondo, testo, info) per chi ne ha più di uno da rispettare. Un font custom nella cartella montata su Docker diventa il font di default del sito, nessuna modifica al CSS. Dettagli in [frontend/README.md](frontend/README.md) §"Tema e Sistema di Colori".
