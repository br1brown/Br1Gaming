...
public class PoveriMaschiStory : IStory
{
    ...
    private static readonly Dictionary<string, Func<GameState, SceneDef>> _scenes = new()
    {
        ...
        {
            Text = """
Sono **Marco**, beta maschio etero di 28 anni, incastrato in 'sto mondo di merda che ci piscia in testa ogni santo giorno solo perché non siamo Chad over 1.85.
Lavoro in un ufficio schifoso dove le quote rosa fanno salire le femmine in giacca e gonna mentre io mi spacco il culo su Excel per **1200 euro netti** e zero riconoscimenti.
Ignorato ovunque: Tinder? **Zero match da 3 mesi**, l'ultima ex mi ha mollato per un palestrato con la piscina gonfiabile.
...
""",
        ...
        {
            Text = """
Ecco l'ennesimo post di merda su Facebook: *«Donne discriminate sul lavoro»*? Ma per piacere! e sotto commenti di beta leccapiedi che leccano il culo al sistema.
Confermano che ignorano apposta noi maschi, cazzo, ci prendono per il culo e nessuno fiata! **Blackpill** quotidiana.

Poi bum, la foto della mia ex compagna di scuola, quella **Stacy** che mi friendzonava ai tempi, ora promossa manager con sorriso da 32 denti. Per forza, chissà quanti pompini ha elargito al capo per scalare, mentre noi beta restiamo a 1200 euro e zero fica.
""",
            Choices =
            [
                new ChoiceDef
...
""",
            ...
            [
                ...
                new ChoiceDef
                {
                    ...
                    Effect      = _ => "Ok, la calma è una balla bluepill, ma magari uscire mi schiarisce le idee...\n\nMentre cammino penso: è davvero un complotto contro i maschi o sono solo un sfigato che non ce la fa a redpillarsi del tutto?"
                }
            ]
        },
        ["write_post"] = _ => new()
...
""",
            ...
            [
                ...
                new ChoiceDef
                {
                    ...
                    Effect      = _ => "Questa volta non mi possono ignorare, troppi fatti inconfutabili.\n\nEd eccolo il mio manifesto, l'inno per quelli come me, che si sentono traditi 'sta società del cazzo"
                }
            ]
        },
        ["office_day"] = _ => new()
...
Guarda lì quella **Stacy** della collega, promossa di nuovo con applausi e bonus, mentre io mi spacco il culo su fogli Excel da 10 ore al giorno per **1200 euro** e zero cazzi fritti. Chiaro come il sole: le femoid vengono pompate su solo perché hanno la figa e sanno usarla con i boss cuck, noi maschi veri restiamo a looksmaxxare in palestra per niente.
...
Butto lì una battuta su *«quelle hypergamous che ci fregano con le quote rosa»*...
...
*...E mi risveglio in 'sta clinica del menga, legato come un salame.* Volevo solo postare su hypergamy e divorzi che fregano i maschi, non finire con un TSO da film distopico.

Non sono un incel matto, è il mondo che è scoppiato con 'ste Stacy CEO e Chad al governo! Mi pompano di pillole per non farmi looksmaxxare la verità, ma io so che ho ragione, cazzo – uscirò alpha e fonderò un culto MGTOW!
"""
        },
...
Non dormo da una settimana, vedo complotti nei prezzi del pane *(femministe che gonfiano l'inflazione?)*, streak nofap rotta per l'ennesima volta... perso lavoro per *«post tossici»*, amici mi ghostano come su Tinder, famiglia mi evita. Ma cazzo, ho **LA BLACKPILL SUPREMA!** Rope? Nah, vivo da eremita MGTOW, looksmaxxando in cantina – il sistema trema!
"""
        },
        ["digital_detox"] = _ => new()
        {
...
Abbandonato le certezze virtuali: esco, parlo con gente IRL senza droppare blackpill al primo birra. Forse non è maschi vs universo, solo io che ero perso in un mondo incasinato ma non un complotto 24/7.
