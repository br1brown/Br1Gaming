...
public sealed class AutoGenerator : GeneratorBase
{
    ...
    /// <inheritdoc />
    public override GeneratorInfo Info { get; } = new() { Order = 7, Name = "Generatore Invettive Automobilistiche", Description = "Non sai cosa dire quando un guidatore fa delle manovre poco piacevoli?" };
