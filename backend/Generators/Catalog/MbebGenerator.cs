...
public sealed class MbebGenerator : GeneratorBase
{
    ...
    [
        ...
        new($"giovane {Professioni.M.Fissato} {Eta.Giovane}enne, {DifettiSociali}", 2),
        ...
        new($"{Professioni.M.Fissato} di {Eta.Anziano} anni, noto per essere {DifettiSociali}", 3),
        new($"{Professioni.M.Fissato}, hater di {Hating} oltre ogni limite", 3),
        new($"{Professioni.M.Fissato} di {Eta.Cresciuto} anni, insopportabilmente {DifettiSociali}", 3),
        new($"{Professioni.M.Fissato}, {DifettiSociali} e cleptomane", 2),
        new($"{Professioni.M.Fissato}, purtroppo {DifettiSociali}", 2),
        new($"{Vibes} di mezza età ({Eta.Adulto} anni), {DifettiSociali} senza vergogna", 3),
        new($"{Professioni.M.Fissato} che rinnega il suo essere {DifettiSociali}", 3),
        new($"{Professioni.M.Fissato} che definirei {DifettiSociali}", 2),
        ...
        new($"ha perso il suo lavoro da {Professioni.M.Fissato} a causa del suo atteggiamento da {DifettiSociali}", 4),
        ...
        new($"nonostante a tutti non piaccia il suo essere un {Professioni.M.Fissato} se ne vanta", 4),
