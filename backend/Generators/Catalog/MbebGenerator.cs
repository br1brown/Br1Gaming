...
public sealed class MbebGenerator : GeneratorBase
{
    ...
    public override Dictionary<string, List<ScoredItem>> FlatLists { get; } = new()
    {
        ...
        [
            ...
            ("ma poi è stra attivo, tipo [5-8] post al giorno", 3),
            ("l'ultima donna che gli ha scritto su [social] era un bot asiatico di criptovalute", 3),
            ("pace all'anima sua", 3),
            ("e lui è convinto che sia perché fanno l'allenamento «da [percezione]»", 3),
            ("anche se lui brucia tutto ogni volta in una padella mezza scrostata", 3),
            ("se escludiamo quella volta a [city] nel [2019-2025] dove gli hanno pure rubato il portafoglio", 3),
    ...
    [
        ...
        ("appena vede [hating] comincia a sghignazzare per motivi che solo un [vibes] trova divertenti (condividendo meme sgranatissimi nel gruppo WhatsApp _«[frasi_tipiche] - [city]»_ seguiti da troppe emoji che ridono)", 10),
        ("apre [social] la notte e si ritrova a discutere sulla _«meravigliosa figura di [idoli]»_ con tono da [difetti_sociali] (scrivendo rigorosamente con l'indice, tenendo il telefono a [14-25] centimetri dal naso)", 10),
        ...
        ("cerca sempre di impressionare con storie di viaggi esotici, ma non ha mai lasciato [city] ([commenti_sprezzanti_generici])", 10),
        ...
        ("si definisce un _«[percezione]»_, ma in realtà ha solo paura di affrontare il mondo", 6),
        ("è terrorizzato all'idea di dover fare lui la telefonata per prenotare nella migliore pizzeria di [city].", 6),
        ("il suo profilo [social] è pieno di citazioni di [idoli] ([commenti_sprezzanti_generici])", 9),
        ...
        ("sostiene di saper cucinare [piatti_perfetti] e si incazza se qualcuno usa gli ingredienti sbagliati ([commenti_sprezzanti_generici])", 20),
